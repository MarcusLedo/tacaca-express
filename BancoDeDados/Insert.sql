INSERT INTO address (address, number_address, address_line2, borough, city, state, postal_code)  VALUES(
	"Rua Ribamar Coelho",
    "15",
	NULL,
    "Guamá",
...
INSERT INTO Address (address, number_address, address_line2, borough, city, state, postal_code)
VALUES
...
INSERT INTO Information_Type (information_type, description)
VALUES 
("P", "Público"),
("R", "Privado"),
("C", "Corporativo");
...
INSERT INTO Employee (employee_name, gender, email, area_code, mobile, insurance_number, father_name, mother_name, hiring_date, dismissal_date, birth_date, marital_status, children, disabled_person, health_plan, driver_license_type, address)
VALUES
...
VALUES
(19, 1, 1, "2021-01-01", NULL),
(19, 2, 1, "2021-01-02", NULL),
(19, 3, 1, "2021-01-03", NULL),
(19, 4, 1, "2021-01-04", NULL),
(19, 5, 1, "2021-01-05", NULL),
(19, 6, 1, "2021-01-06", NULL);

INSERT INTO Unity_Premise (unity, start_date, end_date, premise_type, address)
VALUES
